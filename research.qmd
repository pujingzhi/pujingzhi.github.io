...
![](files/MalEFGK2.png){width="350px" style="border-radius:50%; margin-right:20px};"}
...
![](files/tt_sp.png){width="250px" style="border-radius:50%; margin-right:20px;"}
...
:::{.about-flex style="display: flex; align-items: center;"}
<div>
<!-- ![](files/Region_ips.png){fig-align="center" width="250px"} --> 
...
![](files/Region_ips.png){width="250px" style="border-radius:50%; margin-right:20px;"} 
...
![](files/RP-FM.png){width="350px" style="border-radius:50%; margin-right:20px;"}  
