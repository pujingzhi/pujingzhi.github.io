...
![](files/MalEFGK2.png "*Maltose transporter*"){width="350px",style="border-radius:50%; margin-right:20px};"}
...
![](files/tt_sp.png "*SP lesion in DNA*") {width="250px" style="border-radius:50%; margin-right:20px;"}
