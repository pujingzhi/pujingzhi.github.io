...
:::{.about-flex}
<!-- :::{.about-flex style="display: flex; align-items: flex-start; gap: 5px; flex-wrap: wrap;"} -->
<div style="flex:1; min-width: 300px;">
![](files/MalEFGK2.png){width="300px" style="flex-shrink:0;"}
</div>
<div style="flex:1; min-width: 220px;">
![](files/tt_sp.png){width="220px" style="flex-shrink:0;"}
</div>
<div style="flex:1; min-width: 250px;">
![](files/qmmm.png){width="250px" style="flex-shrink:0;"}
</div>
:::
