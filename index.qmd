...
::: {layout-ncol=3}
![](files/MalEFGK2.png){fig-alt="Maltose transporter from E. coli" width="250px"}
![](files/tt_sp.png){fig-alt="SP lesion in DNA" width="250px"}
![](files/qmmm.png){fig-alt="QM/MM" width="200px"}
:::
