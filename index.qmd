...
[![Research](files/MalEFGK2_tt_sp_qmmm.svg){style="max-width:100%; height:auto; width:770px; display:block; margin:auto;"}](research.qmd)

<!-- <table class="responsive-table" style="width:770px; margin:auto; text-align:center; border-collapse:collapse; border-spacing:0;"> -->
<!--
<table style="width:770px; margin:auto; text-align:center; border-collapse:collapse; border-spacing:0;"> 
<tr>
    <td style="width:310px; padding:0;">
      <img src="files/MalEFGK2.png" width="300px">
    </td>
    <td style="width:210px; padding:0;">
      <img src="files/tt_sp.png" width="200px">
    </td>
    <td style="width:240px; padding:0;">
      <img src="files/qmmm.png" width="240px">
    </td>
  </tr>
</table>
-->
